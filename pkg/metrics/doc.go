...
//   - go_* and process_* series come from client_golang collectors, registered with the bifrost_ prefix
//     (e.g. bifrost_go_memstats_*, bifrost_process_cpu_seconds_total).
package metrics
