...
// ConsumerSettings configures the consumer-group client used on the from side of a relay.
...
// ProducerSettings configures the producer client used on the to side of a relay.
